...
def sample_trajectory(env, policy, max_path_length, render=False, render_mode=('rgb_array')):
    ...
    while True:
        ...
        rollout_done = 1 if done | (steps == max_path_length) else 0  # HINT: this is either 0 or 1
...
def convert_listofrollouts(paths): # list of multiple rollouts to list of one rollout?
    """
